...
namespace UnityEditor.Timeline.Signals
{
    ...
    class SignalEmitterInspector : MarkerInspector, ISignalAssetProvider
    {
        ...
        {
            return !TimelineWindow.instance.state.editSequence.isReadOnly && base.IsEnabled();
        }
        ...
        static void DrawSplitLine(float y)
        {
            ...
            if (EditorStyles.inspectorTitlebar.normal.background != null)
            {
        ...
        {
            if (associatedDirector == null) //if in asset mode, no bound object for you
                return null;
